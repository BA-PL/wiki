...
# Odszukanie nazwy oraz instalacja dodatku

Jeśli mamy już skonfigurowany dostęp do APT - [patrz tutaj](https://ba-pl.github.io/wiki/docs/IPC/Linux/linuxBase.html) - zacznie od komendy update'u:
